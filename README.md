...
「トリビアってすれ違ってほらニヒルに笑って （仮）」

## コンセプト
ここにはプロダクトのコンセプトを書きます。プロダクトの本質的な考え方、発想などを一文か二文で簡潔にまとめるとよいです。
自分ならではのトリビアをすれ違う時に共有して、自己肯定感を上げてキラキラしましょう！(仮)
...
アプリを起動したら自分についての情報とトリビアを入力します
その後アプリを持っている人とすれ違うと、その人のトリビアを受け取れます
トリビアにはへぇーとリアクションすることができ、へぇーの数が多ければ多いほどプロフィールが豪華になります（仮）
